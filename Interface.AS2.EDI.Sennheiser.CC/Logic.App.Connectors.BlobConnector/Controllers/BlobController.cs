using Logic.App.Connectors.BlobConnector.Models;
...
namespace Logic.App.Connectors.BlobConnector.Controllers
{
    public class BlobController : ApiController
    {
        ...
        {
            System.Diagnostics.Trace.TraceInformation($"BlobName: {message.BlobName} {message.MessageBody}");
            ...
            {
                // Parse message
                byte[] byteData = System.Text.Encoding.UTF8.GetBytes(message.MessageBody);
